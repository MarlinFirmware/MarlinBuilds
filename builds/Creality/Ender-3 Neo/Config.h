 ...
 *
 * Exported by Marlin build on 2025-06-24 at 10:44:03.
 */

//
// Info
//
#define STRING_CONFIG_H_AUTHOR                   "(ProMate, default config)"
...
#define Z_SAFE_HOMING_X_POINT                    (X_CENTER) - 5
#define Z_SAFE_HOMING
#define Z_SAFE_HOMING_Y_POINT                    (Y_CENTER) - 5
#define QUICK_HOME

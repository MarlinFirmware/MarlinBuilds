 ...
 *
 * Exported by Marlin build on 2025-06-24 at 11:40:29.
 */

//
// Info
//
#define STRING_CONFIG_H_AUTHOR                   "(M. Baker, Queen Vinyl Da.i'gyu-Kazotetsu)"
...
#define LCD_PROBE_Z_RANGE                        1
#define MESH_BED_LEVELING
#define BED_TRAMMING_Z_HOP                       3.0
#define SEGMENT_LEVELED_MOVES
#define ENABLE_LEVELING_FADE_HEIGHT
#define BED_TRAMMING_HEIGHT                      0.0
#define MESH_EDIT_Z_STEP                         0.020
#define LCD_BED_LEVELING
#define GRID_MAX_POINTS_Y                        GRID_MAX_POINTS_X
#define LEVELED_SEGMENT_LENGTH                   5.0
#define BED_TRAMMING_INSET_LFRB                  { 60, 20, 60, 20 }
